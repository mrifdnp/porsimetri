...
const NAV_ITEMS = [
  ...
  { icon: Users, label: "Pasien Saya", href: "/dashboard/nakes/pasien" },       
  { icon: ClipboardList, label: "Riwayat Konsul", href: "/dashboard/nakes/riwayat" },
  { icon: User, label: "Profil Saya", href: "/dashboard/profile" },
];

export default function NakesSidebar() {
